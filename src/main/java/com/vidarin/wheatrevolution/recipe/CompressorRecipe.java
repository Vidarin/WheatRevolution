...
public class CompressorRecipe implements Recipe<SimpleContainer> {
    ...
    public CompressorRecipe(NonNullList<Ingredient> inputs, ItemStack output, ResourceLocation id) {
        this.inputs = inputs;
        this.output = output;
        this.id = id;
    }
    ...
    public static class Serializer implements RecipeSerializer<CompressorRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation(WheatRevolution.MODID, "compressing");

        @Override
        public CompressorRecipe fromJson(ResourceLocation recipeId, JsonObject jsonObject) {
        ...
        @Override
        public @Nullable CompressorRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buf) {

...
public class AssemblerMachineScreen extends AbstractContainerScreen<AssemblerMachineMenu> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(WheatRevolution.MODID, "textures/gui/assembler_gui.png");
    ...
    private void renderProgressArrow(GuiGraphics guiGraphics, int x, int y) {
        if (menu.isCrafting())
            guiGraphics.blit(TEXTURE, x + 72, y + 34, 176, 64, menu.getProgress(), 14);
    }

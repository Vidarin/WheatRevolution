...
public class LatheMachineMenu extends AbstractContainerMenu {
    public final LatheMachineEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public LatheMachineMenu(int containerId, Inventory inventory, FriendlyByteBuf extraData) {
    ...
    public LatheMachineMenu(int containerId, Inventory inventory, BlockEntity blockEntity, ContainerData data) {
        super(GuiRegistry.LATHE_MACHINE_MENU.get(), containerId);
        checkContainerSize(inventory, 2);
        this.blockEntity = (LatheMachineEntity) blockEntity;
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            this.addSlot(new SlotItemHandler(iItemHandler, 0, 32, 33));
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 111, 33));
        });
    ...
    public int getProgress() {
        ...
        return maxProgress != 0 && progress != 0 ? progress * 57 / maxProgress : 0;
    }
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, BlockRegistry.LATHE_MACHINE.get());
    }
